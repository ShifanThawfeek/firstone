  ...
  <div>
    <v-layout row wrap justify-center>
        <v-flex xl11 sm11 md9 lg9 xl9>
            <p class="mt-10">Preview: 
                <a :href="domain.replace('links', '') + JSON.parse(user).username" target="_blank">
                                ...
                                <v-card-text>
                                    ...
                                    <div style="display: flex; justify-content: flex-end" class="mt-0">
                                        <v-btn-toggle>
                                            ...
                                            <v-btn color="primary accent-3" elevation="0" small @click="copy(link.link)">
                    ...
                    <v-card elevation="0">
                        ...
                        <v-card-text>
                            <v-form ref="form" v-model="valid">
                                ...
                                <v-text-field label="Link" v-model="link" :rules="[rules.required, rules.url]"></v-text-field>
                                
                                <v-switch
                                v-model="is_active"
                                color="cyan accent-3" 
                                :label="`${is_active.toString()}`" 
                               >
                                </v-switch>
            ...
            if (this.valid) {
                ...
                .then(res => {
                    ...
                    this.$refs.form.reset()
                     document.getElementById("input-51").click();
