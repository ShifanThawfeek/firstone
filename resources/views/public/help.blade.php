  ...
  <div class="row text-center d-flex justify-content-center pt-5 mb-3">
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="display: flex; justify-content: center">
      <div class="form-outline">
        <form class="form-inline my-2 my-lg-0">
          <div>
            <button class="btn btn-outline-success my-2 my-sm-0 btn-lg text-white" type="submit" style="background: #17d8e2; border-radius: 18px; width: 190px; height: 110px">
            <a href="/getting_started" style="color: black;">Getting Started with MataOnMe</a> 
            </button>
            &nbsp;&nbsp;&nbsp;
            <button class="btn btn-outline-success my-2 my-sm-0 btn-lg text-white" type="submit" style="background: #17d8e2; border-radius: 18px; width: 190px; height: 110px">
              <p style="color: black;">Our Features</p>
            </button>
            &nbsp;&nbsp;&nbsp;
            <button class="btn btn-outline-success my-2 my-sm-0 btn-lg text-white" type="submit" style="background: #17d8e2; border-radius: 18px; width: 190px; height: 110px">
              <p style="color: black;">Billing & Security</p>
            </button>
            &nbsp;&nbsp;&nbsp;
            <button class="btn btn-outline-success my-2 my-sm-0 btn-lg text-white" type="submit" style="background: #17d8e2; border-radius: 18px; width: 190px; height: 110px">
