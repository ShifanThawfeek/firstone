...
<div class="container-fluid hero">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <p style="font-weight:bold; font-size: 35px;">How to create a link on your MataOnMe</p>
        ...
        <ol>
          ...
          <br>
          <li>Give your link a title, this will appear in the button on your MataOnMe.</li>
        ...
        <p>What to do if your link is not showing on your MataOnMe profile.</p>
        <p>If a link is not displaying on your MataOnMe it could be due to the following:</p>
