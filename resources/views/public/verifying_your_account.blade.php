  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <p>To activate your MataOnMe, you first need to verify your email address. </p>
        <ol>
          <li>Create your MataOnMe, sign up <a href="/">here</a>.</li>
        ...
        <p>Click <a href="how_to_create_link">here</a> to learn how to create a  link on MataOnMe page.</p>
      </div>
    </div>
  </div>
</div>
